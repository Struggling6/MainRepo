...
Output:
    datasets/PowerConsumptionAnomaly/windowed/client1.npz
    ...
    datasets/PowerConsumptionAnomaly/windowed/clientN.npz
    datasets/PowerConsumptionAnomaly/windowed/eval.npz
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--gap-hours", type=int, default=None)
    ...
    parser.add_argument(
        "--oversampling-method",
        choices=("none", "random_over", "smote", "time_series_augment", "ts_augment"),
        default=None,
    )
