...
def inject_noise(input_path, output_path, noise_level):
    ...
    #Tag alle partitions
    #Loop iggenme den og udregn index af hvor test_split starter
    #lav add_guassian_noise for hver partition
    #Så til sidst, når vi er ude af for loopen, så df.noisy(to_csv)
