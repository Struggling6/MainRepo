    ...
    def _oversample_anomalies(
        ...
        *,
        ...
        if method == "random_over":
            ...
            if n_to_generate <= 0:
                print(
                    f"[PCAD] Time-series augmentation skipped for {split_name}; "
            ...
            print(
                f"[PCAD] Applied {split_name} time-series augmentation: "
            ...
            raise ValueError(
                ...
                "Expected 'none', 'random_over', 'smote', or 'time_series_augment'."
            )
